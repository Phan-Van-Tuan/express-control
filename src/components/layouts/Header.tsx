...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-999 flex flex-col w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none dark:bg-gray-800">
      <div className="flex flex-grow items-center md:justify-between justify-end px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className="flex items-center gap-10 2xsm:gap-7">
          <div
            className={`flex items-center gap-2 sm:gap-4 md:hidden h-8 w-8 p-1 cursor-pointer rounded-full ${
              searchbar ? "bg-white border-2 border-blue-600" : null
            }`}
          ...
          <ModeSwitcher />
          <div className="relative">
            <div className="flex items-center gap-4" onClick={handleDropdown}>
              <span className="hidden text-right lg:block text-black dark:text-white">
                <span className="block text-base font-medium ">
                  {user ? user.name : "JPatrick"}
                </span>
                <span className="block text-sm">
                  {user ? user.role : "Undefine"}
                </span>
              </span>
              <span className="h-12 w-12 rounded-full">
                <img src={user?.avatar || "/hacker.png"} alt="User" />{" "}
              </span>
              <img
                src={dropdown ? "/icons/up-arrow.png" : "/icons/down-arrow.png"}
                alt="dropdown"
                className="hidden fill-current sm:block w-6 h-6"
              />
            </div>
            {dropdown ? (
      ...
      {searchbar ? (
        <div className="block mb-4 px-4 md:hidden">
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              <button className="absolute left-0 top-1/2 -translate-y-1/2">
                <img src="/icons/search.png" alt="Search" className="h-5 w-5" />
