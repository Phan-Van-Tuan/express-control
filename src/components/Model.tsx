...
interface ModalProps {
  ...
  description?: string; // Mô tả của modal
  confirmLabel?: string; // Nội dung nút xác nhận
  cancelLabel?: string; // Nội dung nút hủy
  onConfirm?: () => void; // Callback khi nhấn nút xác nhận
