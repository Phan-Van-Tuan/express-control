...
import ModeSwitcher from "./ModeSwicher";

const Header: React.FC = () => {
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none dark:bg-gray-800">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <a
            className="block flex-shrink-0 lg:hidden h-12 w-12 rounded-full"
            href="/"
          >
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="h-12 w-12 rounded-full">
                <img src="/hacker.png" alt="User" />{" "}
              </span>
              {/* <img
                src="/icons/down-arrow.png"
                alt="dropdown"
                className="hidden fill-current sm:block w-4 h-4"
              /> */}
            </a>
            <div className="absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark hidden">
