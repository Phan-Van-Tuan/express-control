import Messenger from "../components/base/Messger";

const Inbox = () => {
  const handleReply = () => alert("Reply clicked!");
  const handleForward = () => alert("Forward clicked!");
  const handleCopy = () => alert("Copy clicked!");
  const handleReport = () => alert("Report clicked!");
  const handleDelete = () => alert("Delete clicked!");
  return (
    <div className="flex flex-1 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
      <div className="sm:w-0 lg:w-1/3 border-e-2 border-gray-200 border-dashed dark:border-gray-700 overflow-hidden">
        <span className="flex items-center p-6 text-gray-800 dark:text-white text-lg font-bold border-b-2 border-gray-200 border-dashed dark:border-gray-700">
          Active Conversations{"  "}
          <p className="w-8 h-8 ml-2 flex items-center justify-center border-2 rounded-md ">
            6
          </p>
        </span>
          ...
          <div className="no-scrollbar max-h-full space-y-2.5 overflow-auto">
            <div className="flex cursor-pointer items-center rounded py-2 px-4 hover:bg-gray-2 dark:hover:bg-strokedark">
              <div className="relative mr-3.5 h-11 w-full max-w-11">
                ...
                />
                <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-gray-2 bg-green-400"></span>
              </div>
            ...
            <div className="flex cursor-pointer items-center rounded py-2 px-4 hover:bg-gray-2 dark:hover:bg-strokedark">
              <div className="relative mr-3.5 h-11 w-full max-w-11">
                <img
                  ...
                  className="h-full w-full object-cover object-center rounded-full"
                />
                <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-gray-2 bg-gray-400"></span>
              </div>
              <div className="w-full">
                <h5 className="text-sm font-medium text-black dark:text-white">
                  Robert Jhon
      ...
      <div className="sm:w-full lg:w-2/3 flex flex-col">
        <div className="sticky flex items-center justify-between pl-4 pr-8 border-b-2 border-gray-200 border-dashed dark:border-gray-700 rounded-tr-lg">
          <div className="flex items-center w-full">
            <div className="p-2 h-13 max-w-13 overflow-hidden rounded-full">
              <img
                src="/hacker.png"
                alt="avatar"
            ...
            <div className="w-full ml-4 justify-start items-start">
                ...
                <button className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4">
                  ...
                  >
                    <g clipPath="url(#clip0_62_9787)">
                      <path
                        d="M15.55 2.97499C15.55 2.77499 15.475 2.57499 15.325 2.42499C15.025 2.12499 14.725 1.82499 14.45 1.52499C14.175 1.24999 13.925 0.974987 13.65 0.724987C13.525 0.574987 13.375 0.474986 13.175 0.449986C12.95 0.424986 12.75 0.474986 12.575 0.624987L10.875 2.32499H2.02495C1.17495 2.32499 0.449951 3.02499 0.449951 3.89999V14C0.449951 14.85 1.14995 15.575 2.02495 15.575H12.15C13 15.575 13.725 14.875 13.725 14V5.12499L15.35 3.49999C15.475 3.34999 15.55 3.17499 15.55 2.97499ZM8.19995 8.99999C8.17495 9.02499 8.17495 9.02499 8.14995 9.02499L6.34995 9.62499L6.94995 7.82499C6.94995 7.79999 6.97495 7.79999 6.97495 7.77499L11.475 3.27499L12.725 4.49999L8.19995 8.99999ZM12.575 
                                        14C12.575 14.25 12.375 14.45 12.125 14.45H2.02495C1.77495 14.45 1.57495 14.25 1.57495 14V3.87499C1.57495 3.62499 1.77495 3.42499 2.02495 3.42499H9.72495L6.17495 6.99999C6.04995 7.12499 5.92495 7.29999 5.87495 7.49999L4.94995 
                                        10.3C4.87495 10.5 4.92495 10.675 5.02495 10.85C5.09995 10.95 5.24995 11.1 5.52495 11.1H5.62495L8.49995 10.15C8.67495 
                                        10.1 8.84995 9.97499 8.97495 9.84999L12.575 6.24999V14ZM13.5 3.72499L12.25 2.49999L13.025 1.72499C13.225 1.92499 14.05 2.74999 14.25 2.97499L13.5 3.72499Z"
                        fill=""
                      ></path>
                    </g>
                    <defs>
        ...
        <div className="px-2 mt-1 flex-1">
          ...
          <Messenger
            ...
            messageText="This is a test 2 message."
            status="Delivered"
            onReply={handleReply}
            onForward={handleForward}
            onCopy={handleCopy}
          ...
          <Messenger
            isMyMessage={true}
            messageTime="10:31 AM"
            messageText="Where are you now? I'm waiting for you. Please reply to me. Thanks."
            status="Delivered"
            onReply={handleReply}
            onForward={handleForward}
            onCopy={handleCopy}
          ...
          <Messenger
            isMyMessage={false}
            messageTime="10:31 AM"
            messageText="What do you think about this? I think it's great!"
            status="Delivered"
            onReply={handleReply}
            onForward={handleForward}
            onCopy={handleCopy}
        ...
        <div className=" dark:bg-gray-700 bg-slate-200 p-4 border-t-[1px] border-gray-300 rounded-br-lg">
          <form className="flex items-center justify-between space-x-4.5">
            <div className="relative w-full">
              <input
                type="text"
                placeholder="Type something here"
                className="h-13 w-full p-2 rounded-md border border-stroke bg-gray pl-5 pr-19 text-black placeholder-body outline-none focus:border-primary dark:border-strokedark dark:bg-gray dark:text-white"
              />
            ...
            <button className="flex h-13 p-2 max-w-13 items-center justify-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
